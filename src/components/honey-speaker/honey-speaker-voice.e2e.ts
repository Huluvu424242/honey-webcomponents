...
describe('E2E Wrapper: voice tests of speaker', () => {
  ...
  const skippen = async () => {
    // Property Wert lesen
    const page = await newE2EPage({html: `<honey-webcomponents verbose audiolang="en" textids="3"></honey-webcomponents><p id="3">test</p>`});
    const stimmenAnzahl = await page.$eval('honey-webcomponents', () => {
  ...
  describe('E2E: voice tests of speaker', () => {
    ...
    beforeEach(async () => {
      ...
      page = await newE2EPage({html: `<honey-webcomponents verbose audiolang="en" textids="3"></honey-webcomponents><p id="3">test</p>`});
    ...
    it('fire event honeySpeakerStarted', async () => {
      ...
      await page.click('honey-webcomponents');
